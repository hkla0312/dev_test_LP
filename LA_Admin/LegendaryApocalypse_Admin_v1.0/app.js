...
(() => {
  ...
  const state = {
    ...
    data: { events: [], artists: [], members: [], artistSignals: [], adminLogs: [] },
  ...
  async function start(user) {
    ...
    collectionSnapshot('events'); collectionSnapshot('artists'); collectionSnapshot('members'); collectionSnapshot('artistSignals'); collectionSnapshot('adminLogs');
